...
const InventoryDetailList = ({
  ...
  border,
  color,
  image, // New image prop
}) => {
  return (
    <div
      style={{ borderTop }}
      className="py-[1.5vh] h-[10vh] px-[2.5vw] flex items-center bg-white justify-center border border-x-0 border-t-0 border-b-[#0000001A]"
    >
      ...
      <div className="flex w-full items-center justify-center">
        {image && (
          <img
            src={image}
            alt="Book"
            className="w-[60px] h-[60px] mr-[10px]" // Adjust the size of the image
          />
        )}
        {texts &&
        ...
        {(editBtn || lastBtn) && (
          <div style={{ width: editBtn || lastBtn ? "20%" : "0px" }} className="w-1/5 flex gap-2">
            {editBtn &&
