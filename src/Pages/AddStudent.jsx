...
const Add = () => {
  ...
  const handleNavigate = () => {
    navigate("/stock"); // Navigate to the home page
  };
  ...
  return (
    <div className="flex flex-col items-start h-full overflow-auto box-border pr-[3%] pb-[3%] bg-[#F8F9FF] gap-3">
      ...
      <div className="grid-container">
        {BasicInformation.map((element, index) => (
          <div key={index} className="grid-item">
            ...
            <input
              type={element === "Admission Date" ? "date" : "text"}
      ...
      <TopLabel label={"Student Details"}
      color="#211951"
      backgroundColor="white" />
      <div className="grid-container">
        {ProductDetails.map((element, index) => {
          ...
          if (element === "Course" || element === "Semester") {
            return (
              <div key={index} className="grid-item">
                <label className="input-label">{element}</label>
          ...
          } else if (element === "Admission Date") {
            inputType = "date";
          } else if (element === "Brief Description") {
            inputType = "textarea";
          } else if (element === "Student Images") {
            inputType = "file";
